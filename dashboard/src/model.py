...
def predict(dates, x, look_ahead):
    ...
    model_fit = model.fit() # conditional sum of squares likelihood is maximized, faster as no Kalmann filter needs to be designed and the full maximum likehood is not computed
