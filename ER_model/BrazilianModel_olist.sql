...
CREATE TABLE IF NOT EXISTS `olist`.`olist_geolocation_dataset` (
  ...
  CONSTRAINT `customer_zip_code_prefix`
    ...
    REFERENCES `olist`.`olist_customers_dataset` (`customer_zip_code_prefix`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `olist`.`olist_customers_dataset` (
  ...
  CONSTRAINT `geolocation_zip_code_prefix`
    FOREIGN KEY (`customer_zip_code_prefix`)
    REFERENCES `olist`.`olist_geolocation_dataset` (`geolocation_zip_code_prefix`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `olist`.`olist_order_items_dataset` (
  ...
  CONSTRAINT `seller_id`
    ...
    REFERENCES `olist`.`olist_sellers_dataset` (`seller_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `product_id`
    FOREIGN KEY (`product_id`)
    REFERENCES `olist`.`olist_products_dataset` (`product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `olist`.`olist_orders_dataset` (
  ...
  CONSTRAINT `customer_id`
    ...
    REFERENCES `olist`.`olist_customers_dataset` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `olist`.`olist_order_reviews_dataset` (
  `review_id` VARCHAR(60) NOT NULL,
  `order_id` VARCHAR(60) NOT NULL,
  `review_score` SMALLINT(5) NULL,
  `review_comment_title` VARCHAR(20) NULL,
  `review_comment_message` VARCHAR(20) NULL,
  ...
  CONSTRAINT `order_id`
    ...
    REFERENCES `olist`.`olist_orders_dataset` (`order_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
